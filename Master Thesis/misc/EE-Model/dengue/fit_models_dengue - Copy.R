...
for(min_lag in 1:1){
  ...
  for(ind in tps){
    ...
    #fit_dengue_end_temp <- hhh4(dengueI_temp, ctrl_dengue_end)
    #save(fit_dengue_end_temp, file = paste0("model_fits/dengue_end",
    #                                       "/fit_dengue_end_Iq", ind, ".rda"))

    # fit ar1 model:
    #fit_dengue_ar1_temp <- hhh4(dengueI_temp, ctrl_dengue_temp)
    #save(fit_dengue_ar1_temp, file = paste0("model_fits/dengue_ar1",
    #                                      "/fit_dengue_ar1_Iq", ind, ".rda"))
