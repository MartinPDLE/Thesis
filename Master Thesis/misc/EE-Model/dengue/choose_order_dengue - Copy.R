...
Iquitos <- read.csv("Iquitos_Training_Data (1).csv")
...
for(max_lag in 2:10){
  ...
  fits_dengue_vary_max_lag$pois[[max_lag]] <- profile_par_lag(I, ctrls_dengue$pois)

  ctrls_dengue$lin$max_lag <- max_lag
  fits_dengue_vary_max_lag$lin[[max_lag]] <- profile_par_lag(I, ctrls_dengue$lin)
  ...
  fits_dengue_vary_max_lag$unres[[max_lag]] <- profile_par_lag(I, ctrls_dengue$unres, start_par_lag = start_par_lag)
